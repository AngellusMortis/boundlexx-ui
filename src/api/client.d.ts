...
declare namespace Components {
    namespace Schemas {
        ...
        export interface ForumFormatPost {
            ...
            can_visit?: boolean;
            /**
             * Can Everyone edit blocks on your world (outside of plots)? Required for Sovereign worlds.
             */
            can_edit?: boolean;
            /**
             * Can Everyone create beacon and plot on your world? Required for Sovereign worlds.
             */
            can_claim?: boolean;
            /**
             * Directions to help players find the portal to your world.Required for Sovereign worlds.
             */
            portal_directions?: string;
            /**
             * Add update link to easily update the template?
             */
            update_link?: boolean;
            /**
             * Use Boundless Forum links for images?
             */
            forum_links?: boolean;
        }
...
declare namespace Paths {
    ...
    namespace ListItems {
        namespace Parameters {
            ...
            export type HasMetalVariants = string;
            export type HasWorldColors = string;
        ...
        export interface QueryParameters {
            ...
            has_metal_variants?: Parameters.HasMetalVariants;
            has_world_colors?: Parameters.HasWorldColors;
            search?: Parameters.Search;
            ordering?: Parameters.Ordering;
        }
        namespace Responses {
    ...
    namespace ListMetals {
        ...
        namespace Responses {
            export interface $200 {
                 ...
                 */
                previous?: string | null; // uri
                results?: Components.Schemas.Metal[];
            }
        }
    }
    ...
    namespace RetrieveMetal {
        ...
        namespace Responses {
            export type $200 = Components.Schemas.Metal;
        }
    }
...
export interface OperationMethods {
    ...
    /**
     * listMetals - List Metals
     *
     * Retrieves the list of metals avaiable in Boundless
     */
    "listMetals"(
        parameters?: Parameters<Paths.ListMetals.QueryParameters>,
        data?: any,
        config?: AxiosRequestConfig,
    ): OperationResponse<Paths.ListMetals.Responses.$200>;
    /**
     * retrieveMetal - Retrieve Metal
     *
     * Retrieves a metal with a given ID
     */
    "retrieveMetal"(
        parameters?: Parameters<Paths.RetrieveMetal.PathParameters & Paths.RetrieveMetal.QueryParameters>,
        data?: any,
        config?: AxiosRequestConfig,
    ): OperationResponse<Paths.RetrieveMetal.Responses.$200>;
    /**
    ...
    "createForumTemplate"(
        ...
        data?: Paths.CreateForumTemplate.RequestBody,
        config?: AxiosRequestConfig,
    ): OperationResponse<Paths.CreateForumTemplate.Responses.$201>;
}
